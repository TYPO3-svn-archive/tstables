...
require_once t3lib_extMgm::extPath('tstables').'model/class.tx_tstables_cell.php';
 ...
 */
class tx_tstables_row extends tx_tstables_abstractElement {
	
	protected $restrictedClassName = 'tx_tstables_cell'; 
